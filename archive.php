...
<?php do_action('show_beautiful_filters'); ?>
		<section id="primary" class="content-area">
			...
			<?php if ( have_posts() ) : ?>
					...
					<h1 class="page-title">
						<?php
							if ( is_category() ) {
								...
								*/
								the_post();
								printf( __( 'Author Archives: %s', 'hana' ), '<span class="vcard"><a class="url fn n" href="' . get_author_posts_url( get_the_author_meta( "ID" ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' );
				...
				<?php hana_content_nav( 'nav-above' ); ?>
