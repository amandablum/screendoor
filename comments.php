...
?>
	...
	<?php if ( have_comments() ) : ?>
		<h2 class="comments-title">
			<?php
				printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'hana' ),
	...
	?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'hana' ); ?></p>
	<?php endif; ?>
