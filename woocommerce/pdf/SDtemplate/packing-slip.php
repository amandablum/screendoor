...
<?php if( $wpo_wcpdf->get_header_logo_id() ) echo apply_filters( 'wpo_wcpdf_invoice_title', __( 'PACKING SLIP', 'wpo_wcpdf' ) ); ?>
</h1>
		...
		<td class="order-data">
			<table>
				...
				<tr class="invoice-date">
					<th><h3><?php _e( 'Pickup Date:', 'wpo_wcpdf' ); ?></h3></th>
					<td><h3><?php $wpo_wcpdf->custom_field('additional_pickupdate', ''); ?></h3></td>
				</tr>
				<?php } ?>
				<tr class="order-date">
		...
		<tr class="no-borders">
			<td class="no-borders">
				<div class="customer-notes">
					...
					<div class="customer-notes">
					<?php if ( $wpo_wcpdf->get_shipping_notes() ) : ?>
						<h3><?php _e( 'Order Notes from Screen Door', 'wpo_wcpdf' ); ?></h3>
